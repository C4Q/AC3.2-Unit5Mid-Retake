...
class DesignTwoViewController: UIViewController, CellTitled {
    ...
    func configureLandscapeConstraints() {
        ...
        pokeballLineConstraints = [
            // center line
            pokeballLineView.topAnchor.constraint(equalTo: view.topAnchor),
            pokeballLineView.bottomAnchor.constraint(equalTo: view.bottomAnchor),
            
            pokeballLineView.leadingAnchor.constraint(equalTo: bottomPokeballView.leadingAnchor),
        ...
        bottomPokeballConstraints = [
            ...
            bottomPokeballView.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: 0.0),
